...
import { skeletonPayloadFields, INDEXING_SCHEMA_VERSION } from '../../../src/indexer/skeleton-payload.js';
...
describe('skeletonPayloadFields — entity_refs (Phase 3U)', () => {
  ...
  it('INDEXING_SCHEMA_VERSION is unchanged at 4 — entity_refs is additive, not a schema-bumping change (see Schema Decision)', () => {
    assert.equal(INDEXING_SCHEMA_VERSION, 4);
  });
});
