...
const SIDEBAR_WIDTH_KEY = 'semidex-admin-sidebar-width';
const SIDEBAR_STEP = 16;
const SIDEBAR_LARGE_STEP = 48;
...
function writeSidebarWidth(storage, value) {
...
function nextSidebarWidth(current, key, shiftKey) {
...
function updateSidebarResizeAria(handle, width) {
