...
// pattern as core/ask-api/v1/route.js and api/generation.js's own
// safeMessage() (code review finding: this endpoint was the one remaining
// raw-detail path — the new #/settings screen surfaces this text directly
// to the user).
