...
import { mount as mountReader } from './features/reader/view.js';
...
export async function route() {
  ...
  else if (r.view === 'collection') currentView = mountReader(main, {
    name: r.name,
    sourceFile: r.openFile,
    nodePath: r.openNodePath,
  });
