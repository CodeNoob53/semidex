 ...
 * Default: bge-m3.
 *
 * @param {{ mode?: 'bge-m3' | 'heuristic' | string, localFilesOnly?: boolean, cloudEmbed?: import('../../core/embedding-profile/cloud-embedding-capability.js').CloudEmbeddingCapability }} [options]
